      ...
      <div className="card w-[80%] lg:w-[70%] md:w-[55%] flex justify-between h-[600px] rounded-xl overflow-hidden shadow-lg">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-gray-500">or use your email</span>
        ...
        <div className="hidden lg:block w-1/2 h-full">
          <img
            src="https://images.pexels.com/photos/6325982/pexels-photo-6325982.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
            alt="Register visual"
